...
```{r hateCrimesByDay, fig.cap = "The day of the week that hate crimes occurred on, 1991-2022", fig.height=16.5}
...
```{r hateCrimesByMonthDay, fig.cap = "The day of the month that hate crimes occurred on, 1991-2022", fig.height=15}
...
final <- data.frame()
for (offense in sort(unique(hate_crimes$ucr_offense_code_1))) {
  temp <- make_frequency_table(hate_crimes %>% filter(ucr_offense_code_1 %in% offense),
                               "bias_motivation_offense_1",
                               c("bias",
                                 "\\# of Incidents",
                                 "\\% of Incidents")) %>%
...
kableExtra::kbl(final, 
                ...
                caption = "The number and percent of biases by offense, 2022.") %>%
  kable_styling(bootstrap_options = "striped", full_width = FALSE, latex_options = c("hold_position", "repeat_header"))
```
...
kableExtra::kbl(final, 
                ...
                caption = "The number and percent of offenses by location, 2022.") %>%
  kable_styling(bootstrap_options = "striped", full_width = FALSE, latex_options = c("hold_position", "repeat_header"))
```
...
hate_crimes$offenders_race_as_a_group[hate_crimes$offenders_race_as_a_group %in% "american indian or native alaskan"] <- "american indian"
hate_crimes$offenders_race_as_a_group[hate_crimes$offenders_race_as_a_group %in% "native hawaiian/other pacific islander"] <- "native hawaiian"
