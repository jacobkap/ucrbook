...
```{r agenciesReportingTable, fig.cap = "The number of agencies in each state reporting to NIBRS and to UCR in 2022. Also shows NIBRS reporting in each state as a percent of UCR reporting."}
