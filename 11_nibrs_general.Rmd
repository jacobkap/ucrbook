...
```{r nibrsStateParticipation2022, fig.cap = "The percent of each state's population that is covered by police agencies reporting at least one month of data to NIBRS, 2022"}
nibrs_state_pop_percent_2022
```

```{r nibrsStateParticipation2022Full, fig.cap = "The percent of each state's population that is covered by police agencies reporting 12 months of data to NIBRS, 2022"}
batch_header_percent_pop <-
  batch_header_all_years %>%
  filter(number_of_months_reported %in% 12,
         year %in% 2022) %>%
