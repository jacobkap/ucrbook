...
kableExtra::kbl(location_offense, 
                ...
                label = "offenseLocation",
                escape = TRUE,
                caption = "The most common offenses for each crime location, 2022.") %>%
  kable_styling(bootstrap_options = "striped", full_width = FALSE, latex_options = c("hold_position", "repeat_header"))
...
```{r offenseAutomaticWeapon, fig.cap = "The percent of firearms used that were fully automatic, for all offenses, 1991-2022."}
nibrs_offense_summary_stats  %>%
  ggplot(aes(x = year)) +
...
```{r offensePremisesEntered, fig.cap = "The distribution in the number of premises entered during burglaries, 2022. This information is only available for burglaries in a hotel/motel or rental storage facilities."}
...
kableExtra::kbl(final, 
                ...
                caption = "The number and percent of offenses by bias motivation, 2022. ") %>%
  kable_styling(bootstrap_options = "striped", full_width = FALSE, latex_options = c("hold_position", "repeat_header"))
```
