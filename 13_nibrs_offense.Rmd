...
temp <- make_frequency_table(offense %>% filter(!type_weapon_force_involved_1 %in% 16:17),
...
kableExtra::kbl(temp, 
                ...
                caption = "The number and percent of incidents that had a bias motivation for all incidents reported in 2022.") %>%
  kable_styling(bootstrap_options = "striped", full_width = FALSE, latex_options = c("hold_position", "repeat_header"))
```
