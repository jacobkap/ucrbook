...
```{r}
hate_crimes <- readRDS("data/ucr_hate_crimes_1991_2020.rds")
```
...
```{r hateCrimesByDay, fig.cap = "The day of the week that hate crimes occurred on, 1991-2020"}
...
```{r hateCrimeOffenderNumber, fig.cap = "The race of offenders, as a group, for hate crime incidents, 1991-2020."}
temp <- hate_crimes %>%
  filter(hate_crime_incident_present %in% "one or more hate crime incidents present") 
...
```{r hateCrimeOffenderRace, fig.cap = "The race of offenders, as a group, for hate crime incidents, 1991-2020."}
hate_crimes %>%
  filter(hate_crime_incident_present %in% "one or more hate crime incidents present") %>%
