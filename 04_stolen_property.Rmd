...
```{r phillyHomeCostPerBurglary, fig.cap = "The annual number of burglaries and cost per burglary for daytime home burglaries in Philadelphia, 1960-2022."}
...
```{r phillyHomeCostPerBurglaryInflation, fig.cap = "The inflation-adjusted annual number of burglaries and cost per burglary for daytime home burglaries in Philadelphia, 1960-2022."}

temp <-
  temp %>%
  mutate(inflation_cost_per_burglary = adjust_for_inflation(cost_per_burglary, year, "US", to_date = 2019),
         inflation_value_burg_resident_day =  adjust_for_inflation(value_burg_resident_day, year, "US", to_date = 2019))
...
```{r agenciesInBoth, fig.cap = "The percent of agencies in the Supplement to Return A data that are also in the Offenses Known and Clearances by Arrest (Return A) data in that year, 1960-2022."}
...
```{r phillyFurValue, fig.cap ="The annual value of stolen clothing and fur in Philadelphia, PA, 1960-2022"}
ucr_property_stolen_recovered_yearly %>%
  dplyr::filter(ori %in% "PAPEP00") %>%
  filter(year < 2019) %>%
