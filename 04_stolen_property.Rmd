...
```{r phillyHomeCostPerBurglaryInflation, fig.cap = "The inflation-adjusted annual number of burglaries and cost per burglary for daytime home burglaries in Philadelphia (2023 dollars), 1960-2022."}

temp <-
  temp %>%
  mutate(inflation_cost_per_burglary = adjust_for_inflation(cost_per_burglary, year, "US", to_date = 2023),
         inflation_value_burg_resident_day =  adjust_for_inflation(value_burg_resident_day, year, "US", to_date = 2023))
...
```{r propertyAgencies12Month, fig.cap = "The annual number of police agencies that report 12 months of data that year."}
ucr_property_stolen_recovered_yearly %>%
