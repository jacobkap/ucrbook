...
{\centering \includegraphics[width=0.9\linewidth]{16_nibrs_arrestee_files/figure-latex/nibrsArresteeAgenciesReporting-1} 

}

\caption{The annual number of agencies reporting data in the NIBRS Arrestee and Group B Arrestee Segments, 1991-2022.}(\#fig:nibrsArresteeAgenciesReporting)
\end{figure}
