...
![(\#fig:nibrsAnnualPercentPopulationIndex)The annual percent of the United States population that is covered by an agency reporting data to NIBRS.](index_files/figure-docx/nibrsAnnualPercentPopulationIndex-1.png){width=100% height=100%}


![(\#fig:nibrsStateParticipation2020Index)The percent of each state's population that is covered by police agencies reporting at least one month of data to NIBRS, 2022.](index_files/figure-docx/nibrsStateParticipation2020Index-1.png){width=100% height=100%}
...
![(\#fig:unnamed-chunk-3)The edit button for how to make edits of this book.](images/edit_button.PNG){width=100% height=100%}
...
![(\#fig:ascii)Fixed-width ASCII file for the 1991 National Incident-Based Reporting System (NIBRS) dataset.](images/nibrs_ascii.PNG){width=100% height=100%}
...
![(\#fig:SRSagenciesReporting)The annual number of agencies reporting to the Offenses Known and Clearances by Arrest dataset. Reporting is based on the agency reporting at least one month of data in that year.](index_files/figure-docx/SRSagenciesReporting-1.png){width=100% height=100%}
...
![(\#fig:nycGunAssaults)Monthly reports of gun assaults in New York City, 1960-2022.](index_files/figure-docx/nycGunAssaults-1.png){width=100% height=100%}
...
![(\#fig:nycMurderMonthly)Monthly murders in New York City, 1990-2022. During the 2000s, the police department began reporting quarterly instead of monthly and then resumed monthly reporting.](index_files/figure-docx/nycMurderMonthly-1.png){width=100% height=100%}
...
![(\#fig:nycMurderYearly)Annual murders in New York City, 1990-2022.](index_files/figure-docx/nycMurderYearly-1.png){width=100% height=100%}
...
![(\#fig:miamiDadeMurderAnnual)Annual murders in Miami-Dade, Florida, 1960-2022.](index_files/figure-docx/miamiDadeMurderAnnual-1.png){width=100% height=100%}
...
![(\#fig:danvilleRape)Annual rapes reported in Danville, CA, 1960-2022.](index_files/figure-docx/danvilleRape-1.png){width=100% height=100%}
