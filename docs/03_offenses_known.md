...
![(\#fig:fbiHierarchy)The FBI's findings of how crime reporting changes when using the Hierarchy Rule using NIBRS 2014 data.](images/fbi_hierarchy.PNG){width=100% height=100%}
...
![(\#fig:sfThefts)Thefts and total index crimes in San Francisco, 2000-2022.](03_offenses_known_files/figure-docx/sfThefts-1.png){width=100% height=100%}
...
![(\#fig:chicagoMurder)Murders in Chicago as a percent of violent index crimes, 1960-2022.](03_offenses_known_files/figure-docx/chicagoMurder-1.png){width=100% height=100%}
...
![(\#fig:simpleIndex)Reported crimes in Houston, Texas, from 1960 to 2018. Violent index crimes are aggravated assault, rape, robbery, and murder.](03_offenses_known_files/figure-docx/simpleIndex-1.png){width=100% height=100%}
...
![(\#fig:offensesAgenciesReporting)The annual number of agencies reporting at least one month of data and a full 12 months of data, 1960-2022.](03_offenses_known_files/figure-docx/offensesAgenciesReporting-1.png){width=100% height=100%}
...
![(\#fig:murdersBothMeasures)The percent change in the number of murders reported in the United States each year when moving from the number of months missing measure to the last month reported measure, 1960-2022.](03_offenses_known_files/figure-docx/murdersBothMeasures-1.png){width=100% height=100%}
...
![(\#fig:newarkMurders)The annual murder rate per 100,000 people in Newark, NJ, 1960-2022.](03_offenses_known_files/figure-docx/newarkMurders-1.png){width=100% height=100%}
...
![(\#fig:lapdClearance)The annual number of actual and cleared murders from the Los Angeles Police Department, 1960-2022.](03_offenses_known_files/figure-docx/lapdClearance-1.png){width=100% height=100%}
...
![(\#fig:frankenmuthRape)The number of actual burglaries reported by the Frankenmuth Police Department, MI, 1960-2022.](03_offenses_known_files/figure-docx/frankenmuthRape-1.png){width=100% height=100%}
...
![(\#fig:memphisUnfounded)The annual number of unfounded crimes in Memphis, TN, 1983-2022.](03_offenses_known_files/figure-docx/memphisUnfounded-1.png){width=100% height=100%}


![(\#fig:denverUnfounded)The annual number of unfounded crimes in Denver, CO, 1983-2022.](03_offenses_known_files/figure-docx/denverUnfounded-1.png){width=100% height=100%}
...
![(\#fig:rapePhilly)The annual number of rapes reported in Philadelphia, Pennsylvania, 2000-2022.](03_offenses_known_files/figure-docx/rapePhilly-1.png){width=100% height=100%}
...
![(\#fig:rapeNYC)The annual number of rapes reported in New York City, 2000-2022.](03_offenses_known_files/figure-docx/rapeNYC-1.png){width=100% height=100%}
...
![(\#fig:rapeLA)The annual number of rapes reported in San Francisco, California, 2000-2022.](03_offenses_known_files/figure-docx/rapeLA-1.png){width=100% height=100%}
...
![(\#fig:rapeJackson)The annual number of rapes reported in Jackson, Mississippi, 2000-2022.](03_offenses_known_files/figure-docx/rapeJackson-1.png){width=100% height=100%}
...
![(\#fig:manslaughterVsMurder)The annual number of murder and non-negligent manslaughter, manslaughter by negligence, and the sum of the two, nationwide from 1960-2022.](03_offenses_known_files/figure-docx/manslaughterVsMurder-1.png){width=100% height=100%}
...
![(\#fig:manslaughterPercent)Reported manslaughter by negligence as a percent of reported murder and non-negligent manslaughter, nationwide 1960-2022.](03_offenses_known_files/figure-docx/manslaughterPercent-1.png){width=100% height=100%}
