...
\caption{The annual number of police agencies that report having at least one assault against a police officer, 1960-2022}\label{fig:leokaAgenciesAssaults}
\end{figure}
...
\caption{The annual number of police agencies that report at least month of data and all 12 months of data that year, 1979-2022.}\label{fig:arsonAgencies}
\end{figure}
...
{\centering \includegraphics[width=0.9\linewidth]{11_nibrs_general_files/figure-latex/nibrsAnnualPopulation-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{11_nibrs_general_files/figure-latex/nibrsStateParticipation2000-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{11_nibrs_general_files/figure-latex/nibrsStateParticipation2010-1} 
...
\caption{The distribution of the injury sustained by the victim, 2022. Only individual and law enforcement officer victims have this variable availablem.}\label{fig:victimInjury}
\end{figure}
...
\caption{The distribution of the injury sustained by the victim for those who had an injury other than 'none' or 'apparent minor injuries,' 2022.}\label{fig:victimInjuryExcludeNone}
\end{figure}
...
\caption{The distribution of residence status for all Law Enforcement Officer victims, 2022.}\label{fig:victimResidenceStatusPolice}
\end{figure}
