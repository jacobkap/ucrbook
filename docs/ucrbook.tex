...
\hypertarget{what-is-an-index-or-part-1-crime-index_crimes}{%
\subsection{What is an index (or part 1) crime? \{index\_crimes\}}\label{what-is-an-index-or-part-1-crime-index_crimes}}
...
\begin{figure}
\includegraphics[width=8.75in]{images/offenses_known_raw_ascii_1960} \caption{Fixed-width ASCII file for the 1960 Offenses Known and Clearances by Arrest dataset}\label{fig:unnamed-chunk-2}
\end{figure}
