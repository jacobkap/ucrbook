...
author = \{Jacob Kaplan\},
year = \{2021\},
url = \{\url{https://github.com/jacobkap/ucrbook}\},
\}
\end{quote}
...
\begin{figure}
\includegraphics[width=9.85in]{images/fbi_hierarchy} \caption{The FBI's findings of how crime reporting changes when using the Hierarchy Rule using NIBRS 2014 data.}\label{fig:fbiHierarchy}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/offensesAgenciesReporting-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/montgomeryClearances-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/phillyRapeUnfound-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/phillyRapeUnfoundPercent-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/phillyRobberyUnfoundPercent-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/rapePhilly-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/rapeNYC-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/rapeLA-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/rapeJackson-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/manslaughterVsMurder-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/manslaughterPercent-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/shrVsOffenses-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/numberSHRVictims-1.pdf}
\caption{\label{fig:numberSHRVictims}The percent of incidents from 1976-2018 that have 1-11 victims.}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/numberSHROffenders-1.pdf}
\caption{\label{fig:numberSHROffenders}The percent of incidents from 1976-2018 that have 1-11 offenders.}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/shrOffenderAge-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/shrVictimAge-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/shrOffenderSex-1.pdf}
\caption{\label{fig:shrOffenderSex}The sex of offenders, 1976-2018.}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/shrVictimSex-1.pdf}
\caption{\label{fig:shrVictimSex}The sex of victims, 1976-2018.}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/shrOffenderRace-1.pdf}
\caption{\label{fig:shrOffenderRace}The race of offenders, 1976-2018.}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/shrVictimRace-1.pdf}
\caption{\label{fig:shrVictimRace}The race of victims, 1976-2018}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/shrOffenderEthnicity-1.pdf}
\caption{\label{fig:shrOffenderEthnicity}The ethnicity of offenders, 1976-2018.}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/shrVictimEthnicity-1.pdf}
\caption{\label{fig:shrVictimEthnicity}The ethnicity of victims, 1976-2018.}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/shrWeapon-1.png}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/shrRelationship-1.png}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/shrCircumstance-1.png}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/shrSubCircumstance-1.png}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/hateAgencies-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/hateCrimesEver-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/hateCrimesPreviousYear-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/hateCrimesMap-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/statePercentReporting-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/hateCrimesByDay-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/crimesPerHateCrime-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/hateBiasMotivation-1.png}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/hateOffense-1.png}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/hateLocations-1.png}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/hateCrimeOffenderNumber-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/hateCrimeOffenderRace-1.pdf}
...
We'll look at home burglaries that occur during the day in Philadelphia. First, we can look at the number of these kinds of burglaries each month or year. Figure @ref()

\includegraphics{ucrbook_files/figure-latex/unnamed-chunk-3-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/PhillyBurglaryCost-1.pdf}
\caption{\label{fig:PhillyBurglaryCost}The total annual cost of daytime home burglaries in Philadelphia.}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/phillyHomeCostPerBurglary-1.pdf}
\caption{\label{fig:phillyHomeCostPerBurglary}The annual number of burglaries and cost per burglary for daytime home burglaries in Philadelphia, 1960-2019.}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/propertyAgencies-1.pdf}
\caption{\label{fig:propertyAgencies}The annual number of police agencies that report at least month of data that year.}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/agenciesInBoth-1.pdf}
\caption{\label{fig:agenciesInBoth}The percent of agencies in the Supplement to Return A data that are also in the Offenses Known and Clearances by Arrest (Return A) data in that year, 1960-2019.}
\end{figure}
...
\hypertarget{a-more-detailed-breakdown-of-property-and-robbery-crimes}{%
\subsection{A more detailed breakdown of property (and robbery) crimes}\label{a-more-detailed-breakdown-of-property-and-robbery-crimes}}
...
The cost is the cost for the victim to replace the stolen item. So the current market price for that item (though factoring in the current state the item is in, e.g.~if it's already damaged) and, for businesses, the cost to buy that item and \emph{not} the cost they sell it for. This is not an exact science so I recommend only interpreting these values are estimates - and potentially rough estimates.

This also includes the value of property stolen during rapes and murders. To be clear, this is \emph{only} the value of the property stolen during the crime. The cost of any injuries (mental or physical) or any lasting cost to the victim, their family, and society for these crimes are not included. This, of course, vastly underestimates the cost of these crimes so please don't use this measure as a cost of crime. It is the cost of property only.
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/nycLivestock-1.pdf}
\caption{\label{fig:nycLivestock}The annual value of stolen livestock in New York City, 1960-2019.}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/phillyGunsValue-1.pdf}
\caption{\label{fig:phillyGunsValue}The annual value of stolen guns in Philadelphia, PA, 1960-2018}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/arsonAgencies-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/arsonClearance-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/residenceArson-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ucrbook_files/figure-latex/arsonCost-1.pdf}
