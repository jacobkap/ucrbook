...
\begin{figure}
\includegraphics[width=9.85in]{images/fbi_hierarchy} \caption{The FBI's findings of how crime reporting changes when using the Hierarchy Rule using NIBRS 2014 data.}(\#fig:fbiHierarchy)
\end{figure}
...
![(\#fig:offensesAgenciesReporting)The annual number of agencies reporting to the Offenses Known and Clearances by Arrest dataset. Reporting is based on the agency reporting at least one month of data in that year.](ucrbook_files/figure-latex/offensesAgenciesReporting-1.pdf) 
...
![(\#fig:montgomeryClearances)The annual number of actual and cleared murders from the Montgomery County Police Department, MD, 1960-2018.](ucrbook_files/figure-latex/montgomeryClearances-1.pdf) 
...
![(\#fig:phillyRapeUnfound)The annual number of actual and unfounded rapes in Philadephia, PA, 1960-2018.](ucrbook_files/figure-latex/phillyRapeUnfound-1.pdf) 
...
![(\#fig:phillyRapeUnfoundPercent)The percent of reported rapes that the police recorded as unfounded in Philadephia, PA, 1960-2018.](ucrbook_files/figure-latex/phillyRapeUnfoundPercent-1.pdf) 
...
![(\#fig:phillyRobberyUnfoundPercent)The percent of reported robberies that the police recorded as unfounded in Philadephia, PA, 1960-2018.](ucrbook_files/figure-latex/phillyRobberyUnfoundPercent-1.pdf) 
...
![(\#fig:rapePhilly)The annual number of rapes reported in Philadelphia, Pennsylvania, 2000-2018.](ucrbook_files/figure-latex/rapePhilly-1.pdf) 
...
![(\#fig:rapeNYC)The annual number of rapes reported in New York City, 2000-2018.](ucrbook_files/figure-latex/rapeNYC-1.pdf) 
...
![(\#fig:rapeLA)The annual number of rapes reported in San Francisco, California, 2000-2018.](ucrbook_files/figure-latex/rapeLA-1.pdf) 
...
![(\#fig:rapeJackson)The annual number of rapes reported in Jackson, Mississippi, 2000-2018.](ucrbook_files/figure-latex/rapeJackson-1.pdf) 
...
![(\#fig:manslaughterVsMurder)The annual number of murder and non-negligent manslaughter, manslaughter by negligence, and the sum of the two, nationwide from 1960-2018.](ucrbook_files/figure-latex/manslaughterVsMurder-1.pdf) 
...
![(\#fig:manslaughterPercent)Reported manslaughter by negligence as a percent of reported murder and non-negligent manslaughter, nationwide 1960-2018.](ucrbook_files/figure-latex/manslaughterPercent-1.pdf) 
