...
<div class="figure" style="text-align: center">
<img src="02_ucr_general_files/figure-html/UCRagenciesReporting-1.png" alt="The annual number of agencies reporting to the Offenses Known and Clearances by Arrest dataset. Reporting is based on the agency reporting at least one month of data in that year." width="90%" />
