...
![(\#fig:arsonAgencies)The annual number of police agencies that report at least month of data that year.](ucrbook_files/figure-latex/arsonAgencies-1.pdf) 
...
![(\#fig:arsonClearance)The annual number of single-family home arsons and clearances in League City, Texas.](ucrbook_files/figure-latex/arsonClearance-1.pdf) 
...
![(\#fig:residenceArson)Annual single-family home arsons in Byron  City, Illinois. The sudden spike to over 400 arsons in a single year is an example of data errors in this dataset. ](ucrbook_files/figure-latex/residenceArson-1.pdf) 
...
![(\#fig:arsonCost)The annual average cost per single-family home arson in Los Angeles, California.](ucrbook_files/figure-latex/arsonCost-1.pdf) 
