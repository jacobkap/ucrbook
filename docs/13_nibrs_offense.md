...
{\centering \includegraphics[width=0.9\linewidth]{13_nibrs_offense_files/figure-latex/nibrsOffenseAgenciesReporting-1} 

}

\caption{The annual number of agencies reporting data in the NIBRS Offense Segment, 1991-2022.}(\#fig:nibrsOffenseAgenciesReporting)
\end{figure}
