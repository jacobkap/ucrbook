...
\caption{Thefts and total index crimes in San Francisco, 1960-2018.}(\#fig:sfThefts)
\end{figure}
...
\caption{Reported crimes in Philadelphia from 1960 to 2018. Violent index crimes are aggravated assault, rape, robbery, and murder.}(\#fig:simpleIndex)
\end{figure}
...
\caption{Fixed-width ASCII file for the 1960 Offenses Known and Clearances by Arrest dataset}(\#fig:unnamed-chunk-3)
\end{figure}
