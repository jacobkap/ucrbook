...
![(\#fig:shrVsOffenses)The annual number of murders from the Supplementary Homicide Report and the Offenses Known and Clearances by Arrest dataset. Numbers differ because agencies voluntarily report and may not report to both datasets.](ucrbook_files/figure-latex/shrVsOffenses-1.pdf) 
...
![(\#fig:numberSHRVictims)The percent of incidents from 1976-2018 that have 1-11 victims.](ucrbook_files/figure-latex/numberSHRVictims-1.pdf) 
...
![(\#fig:numberSHROffenders)The percent of incidents from 1976-2018 that have 1-11 offenders.](ucrbook_files/figure-latex/numberSHROffenders-1.pdf) 
...
![(\#fig:shrOffenderAge)The age of homicide offenders, based on the first offender in any homicide incident. Victims under age 1 (classified as 'birth to 7 days old, including abandoned infant' and '7 days to 364 days old') and considered 0 years old. Victims reported as '99 years or older' are considered 99 years old.](ucrbook_files/figure-latex/shrOffenderAge-1.pdf) 
...
![(\#fig:shrVictimAge)The age of homicide offenders, based on the first offender in any homicide incident. Victims under age 1 (classified as 'birth to 7 days old, including abandoned infant' and '7 days to 364 days old') and considered 0 years old. Victims reported as '99 years or older' are considered 99 years old.](ucrbook_files/figure-latex/shrVictimAge-1.pdf) 
...
![(\#fig:shrOffenderSex)The sex of offenders, 1976-2018.](ucrbook_files/figure-latex/shrOffenderSex-1.pdf) 
...
![(\#fig:shrVictimSex)The sex of victims, 1976-2018.](ucrbook_files/figure-latex/shrVictimSex-1.pdf) 
...
![(\#fig:shrOffenderRace)The race of offenders, 1976-2018.](ucrbook_files/figure-latex/shrOffenderRace-1.pdf) 
...
![(\#fig:shrVictimRace)The race of victims, 1976-2018](ucrbook_files/figure-latex/shrVictimRace-1.pdf) 
...
![(\#fig:shrOffenderEthnicity)The ethnicity of offenders, 1976-2018.](ucrbook_files/figure-latex/shrOffenderEthnicity-1.pdf) 
...
![(\#fig:shrVictimEthnicity)The ethnicity of victims, 1976-2018.](ucrbook_files/figure-latex/shrVictimEthnicity-1.pdf) 
...
![(\#fig:shrWeapon)The weapon used in a homicide incident. In cases where there are multiple offenders, shows only the primary weapon for the first offender.](ucrbook_files/figure-latex/shrWeapon-1.png) 
...
![(\#fig:shrRelationship)The relationship between the first victim and the first offender in a homicide incident.](ucrbook_files/figure-latex/shrRelationship-1.png) 
...
![(\#fig:shrCircumstance)The circumstance of the homicide for the first offender in a homicide incident.](ucrbook_files/figure-latex/shrCircumstance-1.png) 
...
![(\#fig:shrSubCircumstance)The circumstance for the first offender in a homicide incident in cases where the offender is killed. This includes incidents where the only person who dies in the offender.](ucrbook_files/figure-latex/shrSubCircumstance-1.png) 
