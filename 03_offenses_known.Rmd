...
```{r montgomeryClearances, fig.cap = "The annual number of actual and cleared murders from the Montgomery County Police Department, MD, 1960-2022."}
offenses_known_yearly %>%
...
```{r phillyRapeUnfoundPercent, fig.cap = "The percent of reported rapes that the police recorded as unfounded in Philadelphia, PA, 1960-2022."}
offenses_known_yearly %>%
  dplyr::filter(ori %in% "PAPEP00") %>%
...
```{r phillyRobberyUnfoundPercent, fig.cap = "The percent of reported robberies that the police recorded as unfounded in Philadelphia, PA, 1960-2022."}
offenses_known_yearly %>%
  dplyr::filter(ori %in% "PAPEP00") %>%
