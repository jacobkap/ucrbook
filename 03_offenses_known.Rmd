...
offenses_known_yearly %>%
  ...
  geom_line(aes(color = "Reported; >= 1 month"), size = 1.05) +
  geom_line(aes(y = months_missing_any, color = "Missing; >=1 month"), size = 1.05) +
  geom_line(data = offense_12_months, aes(y = last_month_full, color = "Reported; 12 months"), size = 1.05) +
  geom_line(data = offense_12_months, aes(y = months_missing_full, color = "Missing; 12 months"), size = 1.05) +
  xlab("Year") +
  ylab("# of Agencies") +
  theme_crim() +
  scale_color_manual(values = c("Reported; >= 1 month" = "#1b9e77",
                                "Missing; >=1 month" = "#d95f02",
                                "Reported; 12 months" = "#7570b3",
                                "Missing; 12 months" = "black")) +
  scale_y_continuous(labels = scales::comma) +
  labs(color = "") +
  expand_limits(y = 0)
