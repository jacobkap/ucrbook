...
```{r sfThefts, fig.cap = "Thefts and total index crimes in San Francisco, 2000-2022." }
...
```{r chicagoMurder, fig.cap = "Murders in Chicago as a percent of violent index crimes, 1960-2022."}
...
```{r offensesAgenciesReporting, fig.cap="The annual number of agencies reporting at least one month of data and a full 12 months of data, 1960-2022."}
