...
```{r shrVsOffenses, fig.cap = "The annual number of murders from the Supplementary Homicide Report and the Offenses Known and Clearances by Arrest dataset. Numbers differ because agencies voluntarily report and may not report to both datasets.", fig.height=15}
...
```{r chicagoSHRvsOffensesKnown, fig.cap = "The annual number of homicide victims in Chicago, SHR and Offeksnes Known, 1976-2022.", fig.height=15}
...
```{r shrVictimSex, fig.cap = "The sex of victim \\#1, 1976-2022."}
shr %>%
...
```{r shrOffenderRace, fig.cap = "The race of offender \\#1, 1976-2022."}
...
```{r shrVictimRace, fig.cap = "The race of victim \\#1, 1976-2022"}
...
```{r shrOffenderEthnicity, fig.cap = "The ethnicity of offender \\#1, 1976-2022."}
...
```{r shrVictimEthnicity, fig.cap = "The ethnicity of victim \\#1, 1976-2022."}
...
```{r ABQ, fig.cap = "Annual number of offender \\#1 who is Hispanic in Albuquerque, New Mexico, 1976-2022."}
...
shr %>%
  ...
  geom_line(aes(color = "Hispanic"), size = 1.05) +
    geom_line(aes(y = unknown_hispanic_offender, color = "Not Hispanic"), size = 1.05) +
    geom_line(aes(y = not_hispanic_offender, color = "Unknown Ethnicity"), size = 1.05) +
  xlab("Year") +
...
```{r, shrRifle, fig.cap = "The annual number of homicide incidents where offender \\#1's weapon was a rifle, 1976-2022."}
shr$rifle <- 0
...
```{r shrRiflePercent, fig.cap = "The annual share of homicide incidents where offender \\#1's weapon was a rifle, 1976-2022."}
shr %>%
  mutate(dummy = 1) %>%
  group_by(year) %>%
  summarize(rifle = sum(rifle),
