...
```{r}
shr <- readRDS("data/shr_1976_2022.rds")
...
```{r shrVsOffenses, fig.cap = "The annual number of murders from the Supplementary Homicide Report and the Offenses Known and Clearances by Arrest dataset. Numbers differ because agencies voluntarily report and may not report to both datasets. Manslaughter is excluded from SHR data."}
...
```{r, shrVsOffensesylim0, fig.cap = "The annual number of murders from the Supplementary Homicide Report and the Offenses Known and Clearances by Arrest dataset. Numbers differ because agencies voluntarily report and may not report to both datasets."}
ggplot(shr_offenses_known_murders, aes(x = year)) +
  geom_line(aes(y = shr_murders, color = "SHR"), size = 1.02) +
  geom_line(aes(y = offenses_known_murders, color = "Offenses Known"), size = 1.02) +
  geom_line(data = cdc_homicides, aes(x = year, y = homicides, color = "CDC"), size = 1.02) +
...
ggplot(shr_annual_top_agencies, aes(x = year)) +
  ...
  geom_line(aes(y = top_100_incidents, color = "Top 100 Agencies"), size = 1.02) +
  geom_line(aes(y = top_50_incidents, color = "Top 50 Agencies"), size = 1.02) +
  geom_line(aes(y = top_10_incidents, color = "Top 10 Agencies"), size = 1.02) +
  xlab("Year") +
  ylab("# of Homicide Incidents") +
  theme_crim() +
  scale_color_manual(values = c("All Agencies" = "black",
                                "Top 100 Agencies" = "#1b9e77",
                                "Top 50 Agencies" = "#d95f02",
                                "Top 10 Agencies" = "#7570b3")) +
  scale_y_continuous(labels = scales::comma) +
  labs(color = "") +
  expand_limits(y = 0)
```
...
```{r, shrTopAgenciesCountPercent, fig.cap = "The annual percent of homicide incidents by the top 100 agencies (by number of homicide incidents), top 50, and top 10 agencies, 1976-2022."}
ggplot(shr_annual_top_agencies, aes(x = year)) +
  geom_line(aes(y = top_100_percent, color = "Top 100 Agencies"), size = 1.02) +
  geom_line(aes(y = top_50_percent, color = "Top 50 Agencies"), size = 1.02) +
  geom_line(aes(y = top_10_percent, color = "Top 10 Agencies"), size = 1.02) +
  xlab("Year") +
  ylab("% of Homicide Incidents") +
  theme_crim() +
  scale_color_manual(values = c("Top 100 Agencies" = "#1b9e77",
                                "Top 50 Agencies" = "#d95f02",
                                "Top 10 Agencies" = "#7570b3")) +
...
```{r numberSHRVictims, fig.cap = "The percent of incidents from  that have 1-11 victims."}
...
```{r numberSHROffenders, fig.cap = "The percent of incidents from  that have 1-11 offenders."}
shr %>%
...
```{r shrOffenderSex, fig.cap = "The sex of offender #1, 1976-2022."}
...
```{r shrVictimSex, fig.cap = "The sex of victim #1, ."}
shr %>%
...
```{r shrOffenderRace, fig.cap = "The race of offenders, ."}
shr$offender_1_race[shr$offender_1_race %in% "p"] <- "Native Hawaiian/Pacific Islander"
...
```{r shrVictimRace, fig.cap = "The race of victims, "}
shr$victim_1_race[shr$victim_1_race %in% c("P", "p")] <- "Native Hawaiian/Pacific Islander"
...
```{r shrOffenderEthnicity, fig.cap = "The ethnicity of offenders, ."}
...
```{r shrVictimEthnicity, fig.cap = "The ethnicity of victims, ."}
...
```{r shrWeapon}
temp <- make_frequency_table(shr, "offender_1_weapon",
