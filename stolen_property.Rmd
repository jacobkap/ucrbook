...
```{r phillyHomeBurglary2, fig.cap = "The annual number of burglaries and cost per burglary for daytime home burglaries in Philadelphia, 1960-2019."}
temp <- ucr_property_stolen_recovered_yearly_1960_2019 %>%
  dplyr::filter(ori %in% "PAPEP00") %>%
  mutate(cost_per_burglary = value_burg_resident_day / offenses_burg_resident_day)

daytime_home_burglaries <- ggplot(temp, aes(x = year, y = offenses_burg_resident_day )) +
  geom_line(size = 1.05) +
  xlab("Year") +
...
daytime_home_burglaries_value_per <- ggplot(temp, aes(x = year, y = cost_per_burglary )) +
  geom_line(size = 1.05) +
  xlab("Year") +
  ylab("Value of property stolen") +
  theme_crim() +
...
grid.arrange(daytime_home_burglaries,
             daytime_home_burglaries_value_per, ncol = 2)
```
...
```{r nycLivestock, fig.cap = "The annual cost of livestock thefts in New York City, 1960-2019."}
ucr_property_stolen_recovered_yearly_1960_2019 %>%
...
```{r phillyHomeBurglary, fig.cap = "The annual cost per burglary of daytime home burglaries in Philadelphia, 1960-2019."}
ucr_property_stolen_recovered_yearly_1960_2019 %>%
  dplyr::filter(ori %in% "PAPEP00") %>%
  mutate(cost_per_burglary = value_burg_resident_day / offenses_burg_resident_day) %>%
  ggplot(aes(x = year, y = offenses_burg_resident_day )) +
  geom_line(size = 1.05) +
  xlab("Year") +
  ylab("Value of property stolen") +
  theme_crim() +
