...
```{r}
arson <- readRDS("data/arson_yearly_1979_2023.rds")
```
...
```{r residenceArson, fig.cap = "Annual single-family home arsons in Byron  City, Illinois. The sudden spike to over 400 arsons in a single year is an example of data errors in this data set, 1979-2023. "}
arson %>%
