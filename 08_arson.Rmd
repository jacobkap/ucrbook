...
arson %>%
  ...
  geom_line(data = arson_12_months, aes(y = last_month_full, color = "Last Reported; 12 months"), size = 1.05) +
  geom_line(data = arson_12_months, aes(y = months_missing_full, color = "Months Missing; 12 months"), size = 1.05) +
  xlab("Year") +
  ylab("# of Agencies") +
  theme_crim() +
