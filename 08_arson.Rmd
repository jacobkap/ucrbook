...
```{r arsonAgencies, fig.cap = "The annual number of police agencies that report at least month of data and all 12 months of data that year, 1979-2022."}
...
arson %>%
  ...
  geom_line(data = arson_12_months, aes(y = last_month_full, color = "Reported; 12 months"), size = 1.05) +
  geom_line(data = arson_12_months, aes(y = months_missing_full, color = "Missing; 12 months"), size = 1.05) +
  xlab("Year") +
  ylab("# of Agencies") +
  theme_crim() +
