...
```{r arsonAgencies, fig.cap = "The annual number of police agencies that report at least month of data, using both measures of how many months are reported, 1979-2022."}
...
arson %>%
  ...
  ungroup() %>%
  ggplot(aes(x = year, y = last_month_any)) +
 geom_line(data = arson_12_months, aes(y = last_month_full, color = "Last Month Reported"), size = 1.05) +
  geom_line(data = arson_12_months, aes(y = months_missing_full, color = "# of Months Missing"), size = 1.05) +
  xlab("Year") +
  ylab("# of Agencies") +
  theme_crim() +
  scale_color_manual(values = c("Last Month Reported" = "#1b9e77",
