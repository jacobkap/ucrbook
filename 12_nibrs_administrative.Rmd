...
```{r administrativeMonthDayIncident, fig.cap = "The percent of crimes that occur (the day of the incident, even if the crime wasn't reported that day) each day of the month for all agencies reporting to NIBRS in 2022.", fig.height=13}
...
```{r administrativeMonthDayReport, fig.cap = "The percent of crimes that are reported (the day of the report, even if not the day of the incident) each day of the month for all agencies reporting to NIBRS in 2022.", fig.height=13}
...
```{r administrativeHours, fig.cap = "The percent of crimes that are reported each hour for all agencies reporting to NIBRS in 2022.", fig.height=13}
...
nibrs_administrative_summary_stats  %>%
  ...
  geom_line(aes(y = percent_with_arrest_or_cleared_exceptionally , color = "Arrest or Cleared Exceptionally"), size = 1.05) +
  xlab("Year") +
  ylab("% of Incidents") +
  theme_crim() +
  scale_y_continuous(labels = scales::percent) +
  ...
  scale_color_manual(values = c("Arrest" = "#1b9e77",
                                ...
                                "Arrest or Cleared Exceptionally" = "#7570b3"))
```
