...
```{r phillyRapeUnfound, fig.cap = "The annual number of actual and unfounded rapes in Philadelphia, PA, 1960-2018."}
offenses_known_yearly_1960_2018 %>%
...
```{r phillyRapeUnfoundPercent, fig.cap = "The percent of reported rapes that the police recorded as unfounded in Philadelphia, PA, 1960-2018."}
offenses_known_yearly_1960_2018 %>%
  dplyr::filter(ori %in% "PAPEP00") %>%
...
```{r phillyRobberyUnfoundPercent, fig.cap = "The percent of reported robberies that the police recorded as unfounded in Philadelphia, PA, 1960-2018."}
offenses_known_yearly_1960_2018 %>%
  dplyr::filter(ori %in% "PAPEP00") %>%
