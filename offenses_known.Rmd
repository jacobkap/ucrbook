...
```{r, fig.cap="Agency information for the 1960 Offenses Known and Clearances by Arrest dataset"}
knitr::include_graphics('images/offenses_known_agency_info_1960.PNG')
```

```{r, fig.cap="Crime information for the 1960 Offenses Known and Clearances by Arrest dataset"}
