...
all_crimes %>%
  ...
  geom_line(data = arrests_any_month_reporting, aes(y = n, color = "At Least 1 Month")) +
  xlab("Year") +
...
```{r phillyRapeAge, fig.cap = "The total number of rapes by male arrestees reported by arrestee age in Philadelphia, 1974-2022.", fig.height=14}
