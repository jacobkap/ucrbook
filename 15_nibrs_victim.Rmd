...
nibrs_victim_summary  %>%
  ggplot(aes(x = year)) +
  geom_line(aes(y = murder_percent, color = "Murder"), size = 1.05) +
  geom_line(aes(y = sex_offenses_percent , color = "Sex Offenses"), size = 1.05) +
  geom_line(aes(y = vandalism_percent , color = "Vandalism"), size = 1.05) +
  geom_line(aes(y = motor_vehicle_theft_percent , color = "Motor Vehicle Theft"), size = 1.05) +
  xlab("Year") +
