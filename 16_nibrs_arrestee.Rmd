...
arrestee <- readRDS("data/nibrs_arrestee_segment_2023.rds")
window_arrestee <- readRDS("data/nibrs_window_arrestee_segment_2021.rds")
group_b <- readRDS("data/nibrs_group_b_arrest_report_segment_2023.rds")
...
```{r nibrsArresteeMurderWeapon, fig.cap="The share of murder and nonnegligent manslaughter arrestees by weapon carried at arrest, 1991-2023."}
...
kableExtra::kbl(final, 
                ...
                caption = "The number and percent of arrestees by offense and weapon, using the first weapon reported, 2023.") %>%
  kable_styling(bootstrap_options = "striped", full_width = FALSE, latex_options = c("hold_position", "repeat_header"))
...
```{r arresteeAutomaticWeapon, fig.cap = "The percent of firearms the arrestee was carrying that were fully automatic, for the first weapon reported, 1991-2023."}
nibrs_arrestee_summary  %>%
  ggplot(aes(x = year)) +
...
kableExtra::kbl(final, 
                ...
                caption = "The number and percent of arrestees by offense and type of arrest, 2023.") %>%
  kable_styling(bootstrap_options = "striped", full_width = FALSE, latex_options = c("hold_position", "repeat_header"))
...
```{r arresteeJuvenileDisposition, fig.cap = "For juvenile arrestees (under age 18), the distribution of case outcomes, 1991-2023."}
nibrs_arrestee_summary  %>%
  ggplot(aes(x = year)) +
...
```{r nibrsArresteeResidentStatus, fig.cap="Annual resident status (i.e. if they live in the arresting jurisdiction) of arrestees, 1991-2023."}
nibrs_arrestee_summary  %>%
  ggplot(aes(x = year)) +
...
```{r nibrsArresteeAge, fig.cap="The mean and median age of arrestees, 1991-2023."}
nibrs_arrestee_summary  %>%
  ggplot(aes(x = year)) +
...
```{r nibrsArresteeAgeMissing, fig.cap="The percent of arrestee's age that is unknown, 1991-2023."}
nibrs_arrestee_summary  %>%
...
```{r nibrsArresteeSex, fig.cap="The share of arrestees by sex, 1991-2023."}
nibrs_arrestee_summary  %>%
  ggplot(aes(x = year)) +
...
```{r nibrsArresteeRace, fig.cap="The share of arrestees by race, 1991-2023."}
nibrs_arrestee_summary  %>%
  ggplot(aes(x = year)) +
...
```{r nibrsArresteeEthnicity, fig.cap="The share of arrestees by ethnicity, 1991-2023."}
nibrs_arrestee_summary  %>%
  ggplot(aes(x = year)) +
