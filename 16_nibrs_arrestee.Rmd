...
```{r nibrsArresteeAgenciesReporting, fig.cap="The annual number of agencies reporting data in the NIBRS Arrestee and Group B Arrestee Segments, 1991-2022."}
...
```{r arrestsDaysUntilArrest, fig.cap = "The distribution of the number of days from the incident to the arrest date. In 2022 the maximum days from incident to arrest was 461 days. Zero days means that the arrest occurred on the same day as the incident."}
...
```{r arresteeWeapon, fig.cap = "The weapon found on the arrestee for all arrestees reported in 2022."}
...
```{r arresteeWeaponArmed, fig.cap = "The distribution of weapon usage for all arrestees in 2022 who were arrested with a weapon (i.e. excludes unarmed arrestees)."}
...
nibrs_arrestee_summary  %>%
  ...
  geom_line(aes(y = percent_murders_knife , color = "Knife/Cutting Instrument"), size = 1.05) +
  geom_line(aes(y = percent_murders_club_blackjack, color = "Club/Blackjack/Brass Knuckles"), size = 1.05) +
  xlab("Year") +
  ylab("% of Arrestees") +
  theme_crim() +
  ...
  scale_color_manual(values = c("Gun" = "#d7191c",
                                "Handgun" = "#fdae61",
                                "Unarmed" = "#7b3294",
                                "Knife/Cutting Instrument" = "#2c7bb6",
                                "Club/Blackjack/Brass Knuckles" = "black"))
```
...
```{r arresteeAutomaticWeapon, fig.cap = "The percent of firearms the arrestee was carrying that were fully automatic, for arrestees in 2022."}
temp <- 
  arrestee %>%
...
```{r nibrsArresteeArrestType, fig.cap="Annual arrest type for all arrestees, 1991-2022."}
nibrs_arrestee_summary  %>%
  ggplot(aes(x = year)) +
  geom_line(aes(y = percent_arrest_type_on_view, color = "On-View"), size = 1.05) +
  geom_line(aes(y = percent_arrest_type_summoned_cited , color = "Summoned/Cited"), size = 1.05) +
  geom_line(aes(y = percent_arrest_type_taken_into_custody, color = "Taken Into Custody"), size = 1.05) +
  xlab("Year") +
  ylab("% of Arrestees") +
  theme_crim() +
  scale_y_continuous(labels = scales::percent) +
  labs(color = "") +
  expand_limits(y = 0) +
  scale_color_manual(values = c("On-View" = "#1b9e77",
                                "Summoned/Cited" = "#d95f02",
                                "Taken Into Custody" = "#7570b3"))
```

```{r nibrsArresteeDUIArrestType, fig.cap="Annual arrest type for DUI arrestees, 1991-2022."}
nibrs_arrestee_summary  %>%
  ggplot(aes(x = year)) +
  geom_line(aes(y = percent_dui_arrest_type_on_view, color = "On-View"), size = 1.05) +
  geom_line(aes(y = percent_dui_arrest_type_summoned_cited , color = "Summoned/Cited"), size = 1.05) +
  geom_line(aes(y = percent_dui_arrest_type_taken_into_custody, color = "Taken Into Custody"), size = 1.05) +
  xlab("Year") +
  ylab("% of Murder Arrestees") +
  theme_crim() +
  scale_y_continuous(labels = scales::percent) +
  labs(color = "") +
  expand_limits(y = 0) +
...
```{r nibrsArresteeMurderArrestType, fig.cap="Annual arrest type for murder and nonngeligent manslaughter arrestees, 1991-2022."}
nibrs_arrestee_summary  %>%
  ggplot(aes(x = year)) +
  geom_line(aes(y = percent_murder_arrest_type_on_view, color = "On-View"), size = 1.05) +
  geom_line(aes(y = percent_murder_arrest_type_summoned_cited , color = "Summoned/Cited"), size = 1.05) +
  geom_line(aes(y = percent_murder_arrest_type_taken_into_custody, color = "Taken Into Custody"), size = 1.05) +
  xlab("Year") +
  ylab("% of DUI Arrestees") +
  theme_crim() +
  scale_y_continuous(labels = scales::percent) +
  labs(color = "") +
  expand_limits(y = 0) +
...
arrestee$disposition_temp <- arrestee$disposition_of_arrestee_under18
...
```{r arresteeResidenceStatus, fig.cap = "The distribution of residence status for all arrestees reported to NIBRS in 2022. Residence status is residence in the arresting agency's jurisdiction (e.g. do you live in the city you were arrested in?). It is unrelated to citizenship or immigration status."}
...
nibrs_arrestee_summary  %>%
  ...
  geom_line(aes(y = percent_resident_status_unknown, color = "Unknown Resident Status"), size = 1.05) +
  xlab("Year") +
  ylab("% of Arrestees") +
  theme_crim() +
  scale_y_continuous(labels = scales::percent) +
...
```{r arresteeSex, fig.cap = "The sex of all arrestees reported in the 2022 NIBRS data."}
arrestee %>%
...
nibrs_arrestee_summary  %>%
  ...
  geom_line(aes(y = percent_unknown_race, color = "Unknown Race"), size = 1.05) +
  xlab("Year") +
  ylab("% of Arrestees") +
  theme_crim() +
  scale_y_continuous(labels = scales::percent) +
...
```{r arresteeRace, fig.cap = "The race of all arrestees reported in the 2022 NIBRS data."}
...
```{r arresteeEthnicity, fig.cap = "The ethnicity of all arrestees reported in the 2022 NIBRS data."}
...
nibrs_arrestee_summary  %>%
  ...
  geom_line(aes(y = percent_ethnicity_unknown, color = "Unknown Ethnicity"), size = 1.05) +
  xlab("Year") +
  ylab("% of Arrestees") +
  theme_crim() +
  scale_y_continuous(labels = scales::percent) +
