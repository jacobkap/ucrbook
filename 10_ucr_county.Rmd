...
offenses_known_yearly$dummy <- 1
offenses_known_yearly$december_reported <- 0
offenses_known_yearly$december_reported[offenses_known_yearly$last_month_reported %in% "december"] <- 1
offenses_known_yearly %>%
  ...
  mutate(prop_december = december_reported / agencies,
         prop_december_all_agencies = december_reported / length(unique(offenses_known_yearly$ori))) %>% 
  data.frame() %>%
...
```{r countyMap2022, fig.cap = "The share of the population in each county covered by an agency reporting 12 months of data based on their last motnh reported being December, 2022."}
...
```{r countyMap2010, fig.cap = "The share of the population in each county covered by an agency reporting 12 months of data based on their last motnh reported being December, 2010."}
...
```{r countyMap2000, fig.cap = "The share of the population in each county covered by an agency reporting 12 months of data based on their last motnh reported being December, 2000."}
...
knitr::kable(final, 
             ...
             longtable = TRUE,
             escape = FALSE,
             caption = "The mean, median, minimum, and maximum agency size nationwide for all population groups in the 2022 Offenses Known and Clearances by Arrests data.") %>%
  kable_styling(bootstrap_options = "striped", full_width = FALSE, latex_options = c("hold_position", "repeat_header"))
```
...
```{r countyPopulationGroupsBoxplot, fig.cap = "Boxplots showing the distribution of annual murders+gun-assaults for each population group for all agencies that reported December data in 2022.", fig.height=12}
data <- 
  offenses_known_yearly %>%
  filter(year %in% 2022,
         !population_group %in% c("7b", "possessions"),
...
knitr::kable(final, 
             ...
             longtable = TRUE,
             escape = FALSE,
             caption = "The mean, median, minimum, and maximum agency size for agencies in Texas for all population groups in the 2022 Offenses Known and Clearances by Arrests data.") %>%
  kable_styling(bootstrap_options = "striped", full_width = FALSE, latex_options = c("hold_position", "repeat_header"))
```
...
knitr::kable(final, 
             ...
             longtable = TRUE,
             escape = FALSE,
             caption = "The mean, median, minimum, and maximum agency size for agencies in Maine for all population groups in the 2022 Offenses Known and Clearances by Arrests data.") %>%
  kable_styling(bootstrap_options = "striped", full_width = FALSE, latex_options = c("hold_position", "repeat_header"))
```
