...
```{r sfThefts, fig.cap = "Thefts and total index crimes in San Francisco, 1960-2018." }
...
```{r chicagoMurder, fig.cap = "Murders in Chicago as a percent of violent index crimes, 1960-2018."}
...
```{r simpleIndex, fig.cap="Reported crimes in Philadelphia from 1960 to 2018. Violent index crimes are aggravated assault, rape, robbery, and murder."}
...
```{r agenciesReporting, fig.cap="The annual number of agencies reporting to the Offenses Known and Clearances by Arrest dataset. Reporting is based on the agency reporting at least one month of data in that year."}
...
```{r nycGunAssaults, fig.cap = "Monthly reports of gun assaults in New York City, 1960-2018."}
...
```{r nycMurderMonthly, fig.cap = "Monthly murders in New York City, 1960-2018. During the 2000s, the police department began reporting quarterly instead of monthly and then resumed monthly reporting."}
...
```{r nycMurderYearly, fig.cap = "Annual murders in New York City, 1960-2018."}
...
```{r danvilleRape, fig.cap = "Annual rapes reported in Danville, CA, 1960-2018."}
danville <- offenses_known_yearly_1960_2018[offenses_known_yearly_1960_2018$ori %in% "CA00723",]
...
```{r, hateCrimes, fig.cap="Total hate crimes by state, 2018."}
