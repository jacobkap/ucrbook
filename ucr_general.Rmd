...
```{r nycMurderMonthly, fig.cap = "Monthly murders in New York City, 1990-2018. During the 2000s, the police department began reporting quarterly instead of monthly and then resumed monthly reporting."}
nyc %>%
...
```{r nycMurderYearly, fig.cap = "Annual murders in New York City, 1990-2018."}
nyc_annual %>%
  filter(year >= 1990) %>%
ggplot(aes(x = year, y = actual_murder)) +
  geom_line(size = 1.02) +
...
```{r miamiDadeMurderAnnual, fig.cap = "Annual murders in Miami-Dade, Florida, 1960-2018."}
offenses_known_yearly_1960_2018 %>%
...
```{r, hateCrimes, fig.cap="Total reported hate crimes by state, 2018."}
