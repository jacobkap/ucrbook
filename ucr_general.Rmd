...
```{r sfThefts, fig.cap = "Thefts and total index crimes in San Francisco, 2000-2018." }
...
```{r ascii, fig.cap="Fixed-width ASCII file for the 1960 Offenses Known and Clearances by Arrest dataset"}
