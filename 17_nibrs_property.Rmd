...
```{r propertyValuePropertyLevel, fig.cap = "The distribution of the value of property stolen. Each value is rounded to the nearest 100. The x-axis is set on the log scale as this distribution is hugely skewed."}
temp <-
  property %>%
