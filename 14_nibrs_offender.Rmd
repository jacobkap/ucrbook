...
```{r offenderSex, fig.cap = "The sex of all offenders reported in the 2022 NIBRS data."}
...
```{r offenderRace, fig.cap = "The race of all offenders reported in the 2022 NIBRS data."}
offender$race_of_offender[offender$race_of_offender %in% "native hawaiian or other pacific islander"] <- "native hawaiian/other pacific islander"
offender$race_of_offender[offender$race_of_offender %in% "asian/pacific islander"] <- "asian"
